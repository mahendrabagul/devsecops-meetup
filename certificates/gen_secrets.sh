...
kubectl -n devsecops-meetup create secret generic grpc-client-certificates \
...
kubectl -n devsecops-meetup create secret generic grpc-root-ca-and-grpc-server-ca-certificates \
